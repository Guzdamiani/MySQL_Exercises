...
select p.codigo as 'Codigo Producto', p.nombre as 'Producto', f.codigo as 'Codigo Fabricante', f.nombre as 'Fabricante'
from producto p
...
/* 1. Devuelve un listado con todos los nombres de los fabricantes que tienen el mismo número de productos que el fabricante Lenovo. */
	SELECT f.nombre AS nombre_fabricante, COUNT(p.codigo) as cantidad_productos
    FROM fabricante f
